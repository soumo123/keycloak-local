                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td align="">
                            <div class="">
                                <div class="">
                                    <div class="panel" style="background-color: white; padding: 10px 30px; border-radius: 10px; margin-top:30px;">
                                        ...
                                        <p style="text-align:left;background-color: #fff">
                                            ${msg("we_wanted_inform")}
                                        </p>
                                        <p style="text-align:left;background-color: #fff">
                                            ${msg("date_time")}: ${kcSanitize(msg(event.date))?no_esc}
                                            <br>
                                        ...
                                        <p style="text-align:center;background-color: #fff">
                                            ${msg("assistance")}
                                            <a href="helpdesk@akunah.com"> helpdesk@akunah.com.</a>
                                        </p>
                                    </div>
                                </div>
